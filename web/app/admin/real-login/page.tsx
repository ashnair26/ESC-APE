...
export default function RealLoginPage() {
  ...
  const [email, setEmail] = useState('admin@escape.io');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        <div className="text-center">
          <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white">Real Supabase Login</h1>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            This form uses the real Supabase admin_users table
          </p>
        </div>
        ...
        {response && (
          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
              Status: <span className="font-bold">{response.status}</span>
            </p>
