...
# This is only needed for actual execution, not for testing
GETH_POA_MIDDLEWARE_AVAILABLE = False
try:
    from web3.middleware import geth_poa_middleware
    GETH_POA_MIDDLEWARE_AVAILABLE = True
except ImportError:
    try:
        # In newer versions of web3.py, the middleware is in a different location
        from web3.middleware.geth import geth_poa_middleware
        GETH_POA_MIDDLEWARE_AVAILABLE = True
    except ImportError:
        # For testing purposes, we can proceed without the middleware
        pass
...
class BaseClient:
    ...
    def __post_init__(self):
        ...
        if GETH_POA_MIDDLEWARE_AVAILABLE:
